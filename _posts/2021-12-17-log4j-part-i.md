...
📅**2014 July 12**: [Log4j 2.0 is published](https://logging.apache.org/log4j/2.x/changes-report.html#a2.0){:target="_blank"}, first version not alpha o beta, 5 years after the project started.
...
📅**2021 December 14**: The related vulnerability [CVE&#8209;2021&#8209;45046](https://nvd.nist.gov/vuln/detail/CVE-2021-45046){:target="_blank"} is reported for the improved fix It is reported with a score value of just **3.2** (low), 7 days later will be increased to **9.0** (critical).

📅**2021 December 18**: New release 2.17.0 that "protect from infinite recursion in lookup evaluation", same day it's classified as [CVE&#8209;2021&#8209;45105](https://nvd.nist.gov/vuln/detail/CVE-2021-45105){:target="_blank"}.
...
* Vcetor: CVSS:3.1/AV:N/AC:H/PR:H/UI:N/S:U/C:H/I:H/A:H
