...
**Log4j 1.2** is reported on [CVE&#8209;2021&#8209;4104](https://nvd.nist.gov/vuln/detail/CVE-2021-4104){:target="_blank"} with score 8.1 (high), as vulnerable to deserialization of untrusted data when the attacker has write access to the Log4j configuration. This project is at _end of life_, so no fix will be provided to this or other vulnerabilities that may arise.
