...
In "[part II: Kubernetes POC]({% post_url 2022-02-01-log4j-part-ii %})" I explain in my own words how the vulnerability works, and presents details of a Kubernetes _proof of concept_ created by me. On a third part (work in progress), I will analyze security measures, fixes and mitigations.
