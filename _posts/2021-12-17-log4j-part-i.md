...
📅**2021 October 10**: Jfrog reseves ID [CVE-2021-42392](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-42392){:target="_blank"} for a vulnerability they have discovered on the H2 database, where an attacker may pass a JNDI driver name and URL leading to a LDAP or RMI server, causing _remote code execution_. This will not get any press coverage [until January](https://threatpost.com/log4j-related-flaw-h2-database/177448/){:target="_blank"} after the Log4j 2 vulnerability discovery becames mainstrain. The corresponding NVD database extended information, score and vector is not available for quite some time.
