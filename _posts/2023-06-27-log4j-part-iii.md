...
* For specific files, you can query APIs to know if they have been tampered with _extra_ malicious code, like [VirusTotal API](https://developers.virustotal.com/reference/overview) or [CIRCL hashlookup](https://www.circl.lu/services/hashlookup/). Don't blindly trust vulnerability databases, even for things that are reported on NVD, there are important [claims of inaccuracy](https://daniel.haxx.se/blog/2023/06/12/nvd-damage-continued/)inaccuracy, and if you are trying to report a CVE for a software vendor that is a _Certified Numbering Authority_ (they can assign CVE ids), like for example Microsoft is, [they may argue or ignore you preventing the report to move forward](https://www.pluginvulnerabilities.com/2023/01/09/cves-process-for-disputing-a-claimed-vulnerability-is-currently-broken/.
